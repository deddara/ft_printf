...
/*   Updated: 2020/06/13 11:16:08 by deddara          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static void	d_precision_pr_h(long long int res, t_data *data_list, int numb_len)
{
	if (res < 0)
		write(1, "-", 1);
...
static int	d_precision_h(long long int res, t_data *data_list, int numb_len)
{
